...
const AddApps = ({ setIsSelected, handleAdd, theme }) => {
  const [isFormValid, setIsFormValid] = useState(false)
  const [newAppWidgetSettings, setNewAppWidgetSettings] = useState({
    widgetName: 'Your app',
    appIcon: 'https://assets.stickpng.com/images/589b4da582250818d81e748f.png',
    internalAddress: 'https://google.com',
    externalAddress: 'https://google.com',
    AppNamePosition: 'right',
    description: '',
    statusChecker: false,
    newTab: false,
  })
      ...
      <Tabs defaultValue="common" color={theme.primary}>
        ...
        <Tabs.Panel value="appearance" pt="xs">
          ...
          <Select
            ...
            onChange={(e) => setNewAppWidgetSettings({...newAppWidgetSettings, AppNamePosition: e.target.value})}
