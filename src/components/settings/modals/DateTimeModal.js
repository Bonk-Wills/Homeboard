...
const DateTimeModal = ({ isEditModalOpen, setIsEditModalOpen, widgetArray, setWidgetArray, theme }) => {
  ...
  useEffect(() => {
    if (isEditModalOpen && isEditModalOpen.settings) {
      setNewAppWidgetSettings({
        format24: isEditModalOpen.settings.format24,
  ...
  return (
    <>
      ...
      <SwitchContainer>
        <Switch
          color={theme.primary}
          checked={newAppWidgetSettings.format24}
          onChange={() => setNewAppWidgetSettings({ ...newAppWidgetSettings, format24: !newAppWidgetSettings.format24})}
        />
        <SwitchTitle onClick={() => setNewAppWidgetSettings({ ...newAppWidgetSettings, format24: !newAppWidgetSettings.format24})}>
          Display full time (24-hour)
        </SwitchTitle>
      </SwitchContainer>
      <CitySearchContainer theme={theme}>
        <CitySearchTitle theme={theme}>Timezone location</CitySearchTitle>
        <InputsContainer>
